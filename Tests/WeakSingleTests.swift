...
private final class Container {
    lazy var mock = WeakSingle { Mock() }
}

final class WeakSingleTests: XCTestCase {
    ...
    func test_weak_single_different_dependencies() {
        // Arrange
        var mock1: Mock?
        var mock2: Mock?
    ...
    func test_weak_single_object_lifecycle() {
        // Arrange
        var mock: Mock?
        ...
        XCTAssertNotEqual(previousUuid, mock?.uuid)
    }
